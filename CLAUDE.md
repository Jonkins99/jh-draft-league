...
- **Geschrieben wird der Kampfverlauf nur in der Ergebniseingabe** (`battleLogMixin()` in `scheduleView`). Der Teambuilder zeigt ihn nur noch an; eine Sprachaufnahme gibt es nicht mehr.
